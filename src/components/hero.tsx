...
//         ref={ref}
//         id="hero"
//         className={`min-h-screen flex items-center justify-center relative overflow-hidden circuit-board transition-all duration-1000 px-4 sm:px-6 lg:px-8 ${isHovered ? "hero-hover-active" : ""
//           }`}
...
//             <div
//               key={i}
//               className={`absolute w-2 h-2 rounded-full floating transition-all duration-500 ${i % 4 === 0
//                   ? "bg-green-400"
//                   : i % 4 === 1
//                     ? "bg-pink-400"
//                     : i % 4 === 2
...
//         <div
//           className={`text-center z-10 max-w-4xl mx-auto px-4 sm:px-6 fade-in-up transition-transform duration-500 ${isIntersecting ? "animate" : ""} ${isHovered ? "scale-105" : ""}`}
//         >
//           <div className="mb-6 sm:mb-8">
//             <h1 className="font-mono text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-bold mb-4 leading-tight">
//               <span
...
//             </h1>
//             <p
//               className={`text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 font-sans data-stream hover:text-green-400 transition-all duration-500 min-h-[80px] sm:min-h-[100px] md:min-h-[120px] px-2 ${isHovered ? "text-green-300" : ""}`}
//             >
//               {descText}
...
//             <button
//               className="neon-button group relative overflow-hidden hover:scale-110 transition-all duration-300 w-full sm:w-auto text-sm sm:text-base"
...
//           <div className="relative bg-black/90 border-2 border-green-400 rounded-lg p-6 sm:p-8 max-w-md w-full animate-modal-appear">
//             <button
//               onClick={() => setShowCVModal(false)}
//               className="absolute top-3 right-3 sm:top-4 sm:right-4 text-green-400 hover:text-pink-400 transition-colors duration-300 text-xl sm:text-2xl"
//             >
//               ×
//             </button>

//             <div className="text-center">
//               <h3 className="text-xl sm:text-2xl font-mono font-bold text-green-400 mb-4 sm:mb-6 glitch-text">
//                 SELECT CV TYPE
//               </h3>
...
//                   className="w-full cv-option-button group relative overflow-hidden text-sm sm:text-base"
//                 >
//                   <span className="relative z-10 group-hover:text-black transition-colors duration-300">
//                     FRONTEND DEVELOPER
//                   </span>
  ...
  return (
    <>
      <section
        ref={ref}
        id="hero"
        className={`min-h-screen flex items-center justify-center relative overflow-hidden circuit-board transition-all duration-1000 px-4 sm:px-6 lg:px-8 pt-20 sm:pt-16 md:pt-12 lg:pt-8 ${isHovered ? "hero-hover-active" : ""
          }`}
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
      >
        ...
        <div
          className={`text-center z-20 max-w-4xl mx-auto px-2 sm:px-4 fade-in-up transition-transform duration-500 ${isIntersecting ? "animate" : ""} ${isHovered ? "scale-105" : ""}`}
        >
          <div className="mb-4 sm:mb-6 md:mb-8">
            <h1 className="font-mono text-xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-8xl font-bold mb-3 sm:mb-4 leading-tight">
              <span
                className={`glitch-intense holographic hover:scale-105 transition-all duration-300 block ${isHovered ? "text-shadow-intense" : ""}`}
                data-text={titleText}
              >
                {titleText}
              </span>
            ...
            <p
              className={`text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 font-sans data-stream hover:text-green-400 transition-all duration-500 min-h-[40px] sm:min-h-[80px] md:min-h-[100px] px-1 sm:px-2 leading-relaxed ${isHovered ? "text-green-300" : ""}`}
            >
              {descText}
              {showDescCursor && <span className="animate-pulse text-green-400 ml-1">|</span>}
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center items-center mb-4 sm:mb-8 md:mb-12">
            <button
              className="neon-button group relative overflow-hidden hover:scale-110 transition-all duration-300 w-full sm:w-auto text-xs sm:text-sm md:text-base px-4 sm:px-6 py-2 sm:py-3"
              onClick={() => setShowCVModal(true)}
            >
              <span className="relative z-10 group-hover:text-black transition-colors duration-300">DOWNLOAD CV</span>
              <div className="absolute inset-0 bg-green-400 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500"></div>
          ...
          <div className="flex justify-center mt-2 sm:mt-6">
            <div className="w-5 h-8 sm:w-6 sm:h-10 border-2 border-green-400 rounded-full flex justify-center hover:border-pink-400 transition-all duration-300 cursor-pointer bg-black/20 backdrop-blur-sm">
              <div className="w-1 h-2 sm:h-3 bg-green-400 rounded-full mt-1 sm:mt-2 animate-bounce hover:bg-pink-400 transition-colors duration-300" />
            </div>
          </div>
        </div>
      </section>
